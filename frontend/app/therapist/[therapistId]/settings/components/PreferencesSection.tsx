...
function Toggle({
  ...
  return (
    <div className="group rounded-[20px] border border-black/5 bg-white/90 p-4 shadow-[0_6px_14px_rgba(31,23,32,0.04)] transition hover:bg-[#fffafb] hover:shadow-[0_10px_20px_rgba(31,23,32,0.06)]">
...
export function PreferencesSection({
  ...
  update: (next: Partial<TherapistPrefs>) => Promise<void>;
    ...
    <>
      ...
      >
        <div>
          ...
          <p className="mt-2 text-sm leading-6 sm:leading-7 text-[#74656d]">
            Alege cum vrei să rămâi conectată la ședințe, notițe și activitatea din workspace-ul tău.
          </p>
        </div>

        <Toggle
          label="Notificări pe email"
          description="Primești remindere și actualizări importante legate de activitatea ta profesională."
        ...
        <Toggle
          label="Remindere pentru notițe"
          description="Primești o notificare când ai remindere active pentru notițe sau follow-up-uri clinice."
      ...
      >
        <div>
          ...
          <p className="mt-2 text-sm leading-6 sm:leading-7 text-[#74656d]">
            Controlează alertele legate de clienți și modul în care primești notificările în workspace.
          </p>
        </div>

        <Toggle
          label="Alerte pentru clienți noi"
          description="Primești o notificare când un client nou este asociat în workspace-ul tău."
        ...
        <Toggle
          ...
          description="Primești un rezumat săptămânal al sesiunilor și activității tale."
