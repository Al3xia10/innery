    ...
    >
      ...
      <div className="mt-4 flex flex-col gap-2.5 sm:mt-5 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
        ...
        <button
          ...
          className="inline-flex min-h-11 w-full sm:w-auto items-center justify-center rounded-[18px] border border-rose-200 bg-white/80 px-5 py-2.5 text-sm font-semibold text-rose-600 transition hover:bg-rose-50"
        >
          Șterge contul
        </button>
      </div>
