...
function SettingRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-[20px] border border-gray-100 bg-white/70 p-4 sm:rounded-[28px]">
...
>
      ...
      <div className="mt-5 flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs text-gray-500 truncate">ID client: {meUser?.id ?? clientId}</p>
        </div>
      </div>
      ...
      <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <SettingRow label="Rol" value={meUser?.role ?? "Client"} />
        <SettingRow
          label="Mod confidențialitate"
