      ...
      >
        <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_auto] xl:items-start">
            ...
            <div className="grid grid-cols-1 gap-2.5 sm:flex sm:flex-row sm:items-center xl:justify-end xl:mt-1">
              <button
                type="button"
                onClick={openEditModal}
                className="inline-flex min-h-11 w-full sm:w-auto items-center justify-center rounded-[18px] border border-[#ead7df] bg-white px-5 py-2.5 text-sm font-semibold text-[#7d5d6c] shadow-[0_6px_14px_rgba(31,23,32,0.05)] transition hover:bg-[#fff7fa]"
              >
                Editează profilul
              </button>
              ...
              <Link
                href="/client"
                className="inline-flex min-h-11 w-full sm:w-auto items-center justify-center rounded-[18px] bg-(--color-accent) px-5 py-2.5 text-sm font-semibold text-white shadow-[0_10px_20px_rgba(239,135,192,0.25)] transition hover:opacity-90"
              >
                Înapoi la dashboard
              </Link>
            </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-2.5 md:grid-cols-3">
            <div className="rounded-[20px] border border-black/5 bg-white/85 px-4 py-3 shadow-[0_4px_10px_rgba(31,23,32,0.03)] sm:rounded-[28px]">
            ...
            <div className="rounded-[20px] border border-black/5 bg-white/85 px-4 py-4 shadow-[0_4px_10px_rgba(31,23,32,0.03)] sm:rounded-[28px]">
              <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-[#8a7b84]">
                Confidențialitate
              </p>
          ...
          <div className="w-full max-w-2xl overflow-hidden rounded-[28px] border border-black/5 bg-[linear-gradient(180deg,rgba(255,255,255,0.96)_0%,rgba(255,250,251,0.96)_100%)] shadow-[0_24px_60px_rgba(31,23,32,0.16)] sm:rounded-4xl">
            ...
            <div className="flex flex-col-reverse gap-3 border-t border-black/5 px-4 py-4 sm:flex-row sm:justify-end sm:px-7 sm:py-5">
              <button
                type="button"
                onClick={closeEditModal}
                className="inline-flex min-h-11 w-full sm:w-auto items-center justify-center rounded-[18px] border border-black/5 bg-white px-5 py-2.5 text-sm font-semibold text-foreground shadow-[0_6px_14px_rgba(31,23,32,0.05)] transition hover:bg-[#fffafb]"
              >
                Anulează
              </button>
              <button
