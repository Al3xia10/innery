          ...
          <div className="relative grid grid-cols-1 gap-10 md:grid-cols-2 md:items-center">
            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-2 text-xs text-gray-600">
                <span className="rounded-full bg-(--color-card) border border-(--color-soft) px-3 py-1">Private by default</span>
                <span className="rounded-full bg-(--color-card) border border-(--color-soft) px-3 py-1">Built for continuity</span>
                <span className="rounded-full bg-(--color-card) border border-(--color-soft) px-3 py-1">No clutter</span>
              </div>
            </div>
