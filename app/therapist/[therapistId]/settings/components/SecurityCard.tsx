...
export function SecurityCard({ onToast }: { onToast?: (msg: string) => void }) {
  ...
  return (
    <div
      className="rounded-[28px] border border-black/5 p-4 sm:p-6 shadow-[0_10px_24px_rgba(31,23,32,0.05)] sm:rounded-4xl"
      style={{
        background:
    ...
    >
      ...
      <form className="mt-5 grid grid-cols-1 gap-4 sm:mt-6" onSubmit={handleChangePassword}>
        <div className="relative">
          ...
          <input
            ...
            className="mt-1 w-full rounded-[18px] border border-black/5 bg-white px-3 py-2.5 pr-12 text-sm text-foreground sm:px-4 sm:py-3 shadow-[0_4px_10px_rgba(31,23,32,0.03)] outline-none transition focus:border-[#e7bfd2] focus:ring-2 focus:ring-[#f6dce9]"
          ...
          <button
            ...
            className="absolute right-3 top-9.5 inline-flex h-8 w-8 items-center justify-center rounded-[18px] border border-black/5 bg-white text-xs font-semibold text-[#7d5d6c] shadow-[0_4px_10px_rgba(31,23,32,0.03)] transition hover:bg-[#fff7fa]"
        ...
        <div>
          <button
            type="submit"
            disabled={pwSaving}
            className="inline-flex min-h-11 w-full items-center justify-center rounded-[18px] bg-(--color-accent) px-4 py-3 text-center text-sm font-semibold leading-5 text-white shadow-[0_10px_20px_rgba(239,135,192,0.25)] transition hover:opacity-90 disabled:opacity-50 sm:w-auto sm:px-5 sm:py-2.5"
          >
